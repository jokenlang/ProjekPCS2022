...
CREATE TABLE `beverage` (
  ...
  `BEV_NAME` varchar(255) NOT NULL,
  `BEV_PRICE` int(6) NOT NULL DEFAULT 50000,
  `BEV_STATUS` int(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`BEV_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4;

/*Data for the table `beverage` */

insert  into `beverage`(`BEV_ID`,`BEV_AMOUNT`,`BEV_NAME`,`BEV_PRICE`,`BEV_STATUS`) values 
...
(2,'Tiket Printer','3','2022-02-04',2,6000000),
...
(1,'Aaron Linggo Satrio',1,'aron','ronron'),
